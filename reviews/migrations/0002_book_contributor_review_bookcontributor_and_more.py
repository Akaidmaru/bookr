# Generated by Django 4.0.4 on 2022-04-15 20:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_edited', models.DateField(help_text='The date and time the review was last edited.', null=True)),
                ('book', models.ForeignKey(help_text='The Book that this reviews is for.', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),

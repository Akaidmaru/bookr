...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        book = Book.objects.get(pk=request.date['book_id'])
        return Review.objects.create(content=validated_data['content'], book=book,
                                     creator=creator, rating=validated_data['rating'])
